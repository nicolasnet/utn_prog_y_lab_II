...
namespace _20180628_SP.v1
{
    public partial class FrmSenadores : Form
    {
        ...
        public Entidades.SerializarBinaria binario;
            ...
            else
            {
                ...
                if (aux == 0)
                {
                    ...
                    try
                    {
                        ...
                        baseDatos.Guardar("dbo.Votaciones", this.votacion);

                        binario.Guardar("VotacionBinaria", this.votacion); //no le agrego ubicacion para que aparezca en la carpeta del proyecto.
                    }
                    catch (Exception exc)
                    {
